                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">Shipment Management System</h4>
                                <p class="card-text mb-2">Welcome back, please login to your account</p>
                                ...
                                <form method="POST" action="<?=url('')?>/account/dologin">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="john@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
