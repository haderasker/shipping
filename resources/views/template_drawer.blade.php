...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="" style="font-family: cairo !important;">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none">
                            <span class="user-name font-weight-bolder"><?= session("login_info")->user_fullName; ?></span>
                            <span class="user-status"><?= session("login_info")->role_name; ?></span>
                        </div>
                        <span class="avatar"><img class="round" src="<?= url(''); ?>/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= url(''); ?>/html/ltr/vertical-menu-template-semi-dark/index.html"><span class="brand-logo">
    ...
    <script src="<?=url('')?>/assets/js/datatables_tools.js"></script>
...
<script>
    ...
    function initWidgets(){
        ...
        // Disabled Range
        // $('.flatpickr-disabled-range').flatpickr({
        //     dateFormat: 'd-m-Y',
        //     disable: [
        //         {
